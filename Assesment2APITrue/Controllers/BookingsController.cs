...
namespace Assesment2APITrue.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,ClientId,TourEventId,TourName,Payment,DateBooked")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,ClientId,TourEventId,TourName,Payment,DateBooked")] Booking booking)
        {
            if (ModelState.IsValid)
            {
